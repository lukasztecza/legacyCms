...
(function() {
    var makeLayoutFixed = function makeLayoutFixed() {
        ...
        if (subnavigationHeight) {
            ...
            subnavigation.style.boxShadow = "0px -10px 10px 10px #fff";
        }
        navigation.style.boxShadow = "0px -10px 10px 10px #fff";
        ...
        if (header) {
            ...
            header.style.boxShadow = "0px 10px 10px 10px #fff";            
...
(function() {
    ...
    var createInteractiveSidebox = function createInteractiveSidebox() {
        if (document.getElementById("sidebox") !== null && !document.getElementById("sideboxButton")) {
            ...
            sideboxButton.style.backgroundImage = "url('style/graphics/elegantSidebox.jpg')";
            ...
            sideboxUpButton.style.backgroundImage = "url('style/graphics/elegantSideboxUp.png')";
            sideboxDownButton.style.backgroundImage = "url('style/graphics/elegantSideboxDown.png')";
            ...
            sidebox.style.backgroundColor = "#fff";
...
(function() {
    ...
    var CreateSideContactbox = function CreateSideContactbox() {
        if (
            ...
            contactButton.style.backgroundImage = "url('style/graphics/elegantContact.jpg')";
...
(function() {
    ...
    var CreateSideSearchbox = function CreateSideSearchbox() {
        if (
            ...
            searchButton.style.backgroundImage = "url('style/graphics/elegantSearch.jpg')";
