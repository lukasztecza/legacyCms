...
(function() {
    ...
    var makeLayoutFixed = function makeLayoutFixed() {
        ...
        if (window.innerWidth > 768) {
            ...
            section.style.paddingTop = navigationStyle.height;
    ...
    var makeLayoutMobile = function makeLayoutMobile() {
        ...
        if (!document.getElementById("menuButton") && navigation.getElementsByTagName("ul")[0].children.length > 3) {
            ...
            menuButton.style.backgroundImage = "url('style/graphics/blueNavigation.jpg')";
...
(function() {
    ...
    var createInteractiveSidebox = function createInteractiveSidebox() {
        if (document.getElementById("sidebox") !== null && !document.getElementById("sideboxButton")) {
            ...
            sideboxButton.style.backgroundImage = "url('style/graphics/blueSidebox.jpg')";
            ...
            sideboxUpButton.style.backgroundImage = "url('style/graphics/blueSideboxUp.png')";
            sideboxDownButton.style.backgroundImage = "url('style/graphics/blueSideboxDown.png')";
...
(function() {
    ...
    var CreateSideContactbox = function CreateSideContactbox() {
        if (
            ...
            contactButton.style.backgroundImage = "url('style/graphics/blueContact.jpg')";
...
(function() {
    ...
    var CreateSideSearchbox = function CreateSideSearchbox() {
        if (
            ...
            searchButton.style.backgroundImage = "url('style/graphics/blueSearch.jpg')";
