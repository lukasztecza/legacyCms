...
(function() {
    var makeLayoutFixed = function makeLayoutFixed() {
        var body = document.querySelector("body"),
            bodyStyle = window.getComputedStyle(body) || body.currentStyle,
            navigation = document.querySelector("body > nav"),
            navigationStyle = window.getComputedStyle(navigation) || navigation.currentStyle,
            subnavigation = document.querySelector("body > section > nav"),
            subnavigationStyle = window.getComputedStyle(subnavigation) || subnavigation.currentStyle,
            section = document.querySelector("body > section"),
            sectionStyle = window.getComputedStyle(section) || section.currentStyle,
            header = document.querySelector("body > section > article > h1"),
            headerStyle = header && (window.getComputedStyle(header) || header.currentStyle),
            headerHeightCorrection = 0,
            languages = document.querySelector("body > header > div"),
            languagesStyle = window.getComputedStyle(languages) || languages.currentStyle,
            windowWidth = window.innerWidth,
            windowHeight = window.innerHeight,
            visibleHeight;
        
        if (subnavigation.children[0].children.length) {
            subnavigationHeight = parseInt(subnavigationStyle.height);
        } else {
        ...
        if (subnavigationHeight) {
            ...
            subnavigation.style.width = "100%";
            subnavigation.style.left = 0;
            subnavigation.style.bottom = parseInt(navigationStyle.height);
            subnavigation.style.zIndex = 1;
            subnavigation.style.boxShadow = "0px -10px 10px 10px #336677";
        }
        navigation.style.boxShadow = "0px -10px 10px 10px #336677";
        
        if (header) {
            header.style.position = "fixed";
            header.style.top = 0;
            header.style.left = 0;
            header.style.backgroundColor = "#336677";
            header.style.zIndex = 1;
            header.style.boxShadow = "0px 10px 10px 10px #336677";            
            header.style.minWidth = 0;
            header.style.paddingLeft = "5px";        
            header.style.minWidth = "100%";
            headerHeightCorrection = parseInt(headerStyle.height);
        }
        
        section.style.marginTop = headerHeightCorrection + 25;
        section.style.paddingBottom = parseInt(navigationStyle.height) + subnavigationHeight + 20;
        visibleHeight = windowHeight - parseInt(navigationStyle.height) - subnavigationHeight - headerHeightCorrection - 45;
        if (visibleHeight > parseInt(sectionStyle.height)) {
            section.style.marginTop = ((visibleHeight - parseInt(sectionStyle.height)) / 2) + headerHeightCorrection + 25;
        }
    ...
    var makeLayoutStatic = function makeLayoutStatic() {
        ...
        subnavigation.style.position = "static";
        languages.style.position = "static";
    ...
    if (window.innerWidth > 640) {
        setTimeout(makeLayoutFixed, 0);//workaround to let browser calculate its height
    } else {
        makeLayoutStatic();
    }
...
(function() {
    ...
    var createInteractiveSidebox = function createInteractiveSidebox() {
        if (document.getElementById("sidebox") !== null && !document.getElementById("sideboxButton")) {
            ...
            sideboxButton.style.backgroundImage = "url('style/graphics/simpleSidebox.jpg')";
            ...
            sideboxUpButton.style.backgroundImage = "url('style/graphics/simpleSideboxUp.png')";
            sideboxDownButton.style.backgroundImage = "url('style/graphics/simpleSideboxDown.png')";
            ...
            sidebox.style.top = 65;
            sidebox.style.backgroundColor = "#336677";
...
(function() {
    ...
    var CreateSideContactbox = function CreateSideContactbox() {
        if (
            ...
            contactButton.style.backgroundImage = "url('style/graphics/simpleContact.jpg')";
            ...
            contactBox.style.top = 125 - topCorrection;
            contactBox.style.backgroundColor = "#336677";
...
(function() {
    ...
    var CreateSideSearchbox = function CreateSideSearchbox() {
        if (
            ...
            searchButton.style.backgroundImage = "url('style/graphics/simpleSearch.jpg')";
            ...
            searchBox.style.top = 185 - topCorrection;
            searchBox.style.backgroundColor = "#336677";
    ...
    var makeLinksFixed = function makeLinksFixed() {
        ...
        while (socialMedialength--) {
            ...
            if (element) {
                ...
                element.style.top = 245 + socialMedialength * 60 - topCorrection;
            }
        }
    }
